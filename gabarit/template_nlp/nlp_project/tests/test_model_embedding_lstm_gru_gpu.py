...
from {{package_name}}.models_training.model_embedding_lstm_gru_gpu import ModelEmbeddingLstmGruGpu
...
class ModelEmbeddingLstmGruGpuTests(unittest.TestCase):
    ...
    def test02_model_embedding_lstm_gru_gpu_predict_proba(self):
        '''Test of {{package_name}}.models_training.model_embedding_lstm_gru_gpu.ModelEmbeddingLstmGruGpu.predict_proba'''
    ...
    def test03_model_embedding_lstm_gru_gpu_prepare_x_train(self):
        '''Test of {{package_name}}.models_training.model_embedding_lstm_gru_gpu.ModelEmbeddingLstmGruGpu._prepare_x_train'''
    ...
    def test04_model_embedding_lstm_gru_gpu_prepare_x_test(self):
        '''Test of {{package_name}}.models_training.model_embedding_lstm_gru_gpu.ModelEmbeddingLstmGruGpu._prepare_x_test'''
    ...
    def test05_model_embedding_lstm_gru_gpu_get_model(self):
        '''Test of {{package_name}}.models_training.model_embedding_lstm_gru_gpu.ModelEmbeddingLstmGruGpu._get_model'''
    ...
    def test06_model_embedding_lstm_gru_gpu_save(self):
        '''Test of the method save of {{package_name}}.models_training.model_embedding_lstm_gru_gpu.ModelEmbeddingLstmGruGpu'''
    ...
    def test07_model_embedding_lstm_gru_gpu_reload_model(self):
        '''Test of the method reload_model of {{package_name}}.models_training.model_embedding_lstm_gru_gpu.ModelEmbeddingLstmGruGpu'''
    ...
    def test08_test_model_embedding_lstm_gru_gpu_reload_from_standalone(self):
        '''Test of the method {{package_name}}.models_training.model_embedding_lstm_gru_gpu.ModelEmbeddingLstmGruGpu.reload_from_standalone'''
