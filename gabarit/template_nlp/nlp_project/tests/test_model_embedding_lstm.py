...
class ModelEmbeddingLstmTests(unittest.TestCase):
    ...
    def test07_model_embedding_lstm_reload_model(self):
        '''Test of the method reload_model of {{package_name}}.models_training.models_tensorflow.model_embedding_lstm.ModelEmbeddingLstm'''
    ...
    def test08_test_model_embedding_lstm_reload_from_standalone(self):
        '''Test of the method {{package_name}}.models_training.models_tensorflow.model_embedding_lstm.ModelEmbeddingLstm.reload_from_standalone'''
