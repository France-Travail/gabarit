...
class ModelEmbeddingLstmTests(unittest.TestCase):
    ...
    def test01_model_embedding_lstm_init(self):
        '''Test of {{package_name}}.models_training.model_embedding_lstm.ModelEmbeddingLstm.__init__'''
    ...
    def test02_model_embedding_lstm_predict_proba(self):
        '''Test of {{package_name}}.models_training.model_embedding_lstm.ModelEmbeddingLstm.predict_proba'''
    ...
    def test03_model_embedding_lstm_prepare_x_train(self):
        '''Test of {{package_name}}.models_training.model_embedding_lstm.ModelEmbeddingLstm._prepare_x_train'''
    ...
    def test04_model_embedding_lstm_prepare_x_test(self):
        '''Test of {{package_name}}.models_training.model_embedding_lstm.ModelEmbeddingLstm._prepare_x_test'''
    ...
    def test05_model_embedding_lstm_get_model(self):
        '''Test of {{package_name}}.models_training.model_embedding_lstm.ModelEmbeddingLstm._get_model'''
    ...
    def test06_model_embedding_lstm_save(self):
        '''Test of the method save of {{package_name}}.models_training.model_embedding_lstm.ModelEmbeddingLstm'''
    ...
    def test07_model_embedding_lstm_reload_model(self):
        '''Test of the method reload_model of {{package_name}}.models_training.model_embedding_lstm.ModelEmbeddingLstm'''
