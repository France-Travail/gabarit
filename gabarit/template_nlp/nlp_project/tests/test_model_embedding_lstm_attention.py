...
class ModelEmbeddingLstmAttentionTests(unittest.TestCase):
    ...
    def check_weights_equality(self, model_1, model_2):
        ...
        for layer_nb, x1, x2 in [(5, 1, 100), (17, 123, 132)]:
    ...
    def test07_model_embedding_lstm_attention_init_new_instance_from_configs(self):
        '''Test of the method _init_new_instance_from_configs of {{package_name}}.models_training.models_tensorflow.model_embedding_lstm_attention.ModelEmbeddingLstmAttention'''
        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)
        ...
        new_model = ModelEmbeddingLstmAttention._init_new_instance_from_configs(configs=configs)
        self.assertTrue(isinstance(new_model, ModelEmbeddingLstmAttention))
    ...
    def test08_model_embedding_lstm_attention_load_standalone_files(self):
        '''Test of the method _load_standalone_files of {{package_name}}.models_training.models_tensorflow.model_embedding_lstm_attention.ModelEmbeddingLstmAttention'''
        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)
        ...
        model = ModelEmbeddingLstmAttention(model_dir=model_dir, embedding_name='fake_embedding.pkl')
    ...
    def test09_model_embedding_lstm_attention_fit_with_seed(self):
        '''Test random seed for {{package_name}}.models_training.models_tensorflow.model_embedding_lstm_attention.ModelEmbeddingLstmAttention'''
        ...
        model1 = ModelEmbeddingLstmAttention(model_dir=model_dir, batch_size=64, epochs=2, multi_label=False,
                                  max_sequence_length=10, max_words=100, random_seed=42,
                                  padding='pre', truncating='post',
                                  embedding_name='fake_embedding.pkl')
        model1.fit(x_train, y_train_mono)
        model2 = ModelEmbeddingLstmAttention(model_dir=model_dir2, batch_size=64, epochs=2, multi_label=False,
                                  max_sequence_length=10, max_words=100, random_seed=42,
                                  padding='pre', truncating='post',
                                  embedding_name='fake_embedding.pkl')
        ...
        model1 = ModelEmbeddingLstmAttention(model_dir=model_dir, batch_size=64, epochs=2, multi_label=True,
                                  max_sequence_length=10, max_words=100, random_seed=42,
                                  padding='pre', truncating='post',
                                  embedding_name='fake_embedding.pkl')
        model1.fit(x_train, y_train_multi)
        model2 = ModelEmbeddingLstmAttention(model_dir=model_dir2, batch_size=64, epochs=2, multi_label=True,
                                  max_sequence_length=10, max_words=100, random_seed=42,
                                  padding='pre', truncating='post',
                                  embedding_name='fake_embedding.pkl')
