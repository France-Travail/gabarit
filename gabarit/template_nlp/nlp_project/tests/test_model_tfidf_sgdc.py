...
class ModelTfidfSgdcTests(unittest.TestCase):
    ...
    def test07_model_tfidf_sgdc_with_super_documents(self):
        '''Test of the fit and predict with super documents of {{package_name}}.models_training.model_tfidf_sgdc.ModelTfidfSgdc'''
        ...
        model = ModelTfidfSgdc(model_dir=model_dir)
        model_s = ModelTfidfSgdc(model_dir=model_dir, with_super_documents=True)
