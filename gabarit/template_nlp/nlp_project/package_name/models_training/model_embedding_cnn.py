...
#
# Classes :
# - ModelEmbeddingCnn -> Model for predictions via embedding + CNN
...
class ModelEmbeddingCnn(ModelKeras):
    ...
    def predict_proba(self, x_test, with_new_embedding: bool = False, experimental_version: bool = False, **kwargs) -> np.ndarray:
        ...
        # Else, get new tokenizer/embedding matrix
            ...
            for i, layer in enumerate(self.model.layers[1:]):  # type: ignore
                tmp_model.layers[i + 1].set_weights(layer.get_weights())
