...
class Case1_e2e_pipeline(unittest.TestCase):
    ...
    def test04_GenerateReport(self):
        ...
        # With target
        test_target = f"{activate_venv}python {full_path_lib}/test_template_num-scripts/utils/0_generate_report.py -s mono_class_mono_label.csv --source_names source_with_target -t y_col --config {config_path}"
