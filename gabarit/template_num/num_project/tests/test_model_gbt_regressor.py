...
class ModelGBTRegressorTests(unittest.TestCase):
    ...
    def test04_model_gbt_regressor_reload_from_standalone(self):
        '''Test of the method {{package_name}}.models_training.regressors.models_sklearn.model_gbt_regressor.ModelGBTRegressor.reload_from_standalone'''
        ...
        new_model = ModelGBTRegressor(model_dir=model_dir_2)
