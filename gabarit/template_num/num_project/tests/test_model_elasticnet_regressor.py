...
from {{package_name}}.models_training.regressors.models_sklearn.model_elasticnet_regressor import ModelElasticNetRegressor
...
class ModelElasticNetRegressorTests(unittest.TestCase):
    ...
    def test01_model_elasticnet_regressor_init(self):
        '''Test of the initialization of {{package_name}}.models_training.model_elasticnet_regressor.ModelElasticNetRegressor'''
    ...
    def test02_model_elasticnet_regressor_predict(self):
        '''Test of the method predict of {{package_name}}.models_training.model_elasticnet_regressor.ModelElasticNetRegressor'''
    ...
    def test03_model_elasticnet_regressor_save(self):
        '''Test of the method save of {{package_name}}.models_training.model_elasticnet_regressor.ModelElasticNetRegressor'''
        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)
    ...
    def test04_model_elasticnet_regressor_reload_from_standalone(self):
        '''Test of the method {{package_name}}.models_training.regressors.models_sklearn.model_elasticnet_regressor.ModelElasticNetRegressor.reload_from_standalone'''
        ...
        new_model = ModelElasticNetRegressor(model_dir=model_dir_2)
