...
from {{package_name}}.models_training.regressors.models_sklearn.model_knn_regressor import ModelKNNRegressor
...
class ModelKNNRegressorTests(unittest.TestCase):
    ...
    def test01_model_knn_regressor_init(self):
        '''Test of the initialization of {{package_name}}.models_training.model_knn_regressor.ModelKNNRegressor'''
    ...
    def test02_model_knn_regressor_predict(self):
        '''Test of the method predict of {{package_name}}.models_training.model_knn_regressor.ModelKNNRegressor'''
    ...
    def test03_model_knn_regressor_save(self):
        '''Test of the method save of {{package_name}}.models_training.model_knn_regressor.ModelKNNRegressor'''
        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)
    ...
    def test04_model_knn_regressor_reload_from_standalone(self):
        '''Test of the method {{package_name}}.models_training.regressors.models_sklearn.model_knn_regressor.ModelKNNRegressor.reload_from_standalone'''
        ...
        new_model = ModelKNNRegressor(model_dir=model_dir_2)
