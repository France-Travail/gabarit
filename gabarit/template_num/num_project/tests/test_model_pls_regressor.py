...
from {{package_name}}.models_training.regressors.models_sklearn.model_pls_regressor import ModelPLSRegressor
...
class ModelPLSRegressorTests(unittest.TestCase):
    ...
    def test01_model_pls_regressor_init(self):
        '''Test of the initialization of {{package_name}}.models_training.model_pls_regressor.ModelPLSRegressor'''
    ...
    def test02_model_pls_regressor_predict(self):
        '''Test of the method predict of {{package_name}}.models_training.model_pls_regressor.ModelPLSRegressor'''
    ...
    def test03_model_pls_regressor_save(self):
        '''Test of the method save of {{package_name}}.models_training.model_pls_regressor.ModelPLSRegressor'''
        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)
    ...
    def test04_model_pls_regressor_reload_from_standalone(self):
        '''Test of the method {{package_name}}.models_training.regressors.models_sklearn.model_pls_regressor.ModelPLSRegressor.reload_from_standalone'''
        ...
        new_model = ModelPLSRegressor(model_dir=model_dir_2)
