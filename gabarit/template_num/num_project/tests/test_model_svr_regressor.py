...
from {{package_name}}.models_training.regressors.model_svr_regressor import ModelSVRRegressor
...
class ModelSVRRegressorTests(unittest.TestCase):
    ...
    def test04_model_svr_regressor_reload_from_standalone(self):
        '''Test of the method {{package_name}}.models_training.regressors.model_svr_regressor.ModelSVRRegressor.reload_from_standalone'''
