...
from {{package_name}}.models_training.regressors.models_sklearn.model_lgbm_regressor import ModelLGBMRegressor
...
class ModelLGBMRegressorTests(unittest.TestCase):
    ...
    def test01_model_lgbm_regressor_init(self):
        '''Test of the initialization of {{package_name}}.models_training.model_lgbm_regressor.ModelLGBMRegressor'''
    ...
    def test03_model_lgbm_regressor_save(self):
        '''Test of the method save of {{package_name}}.models_training.model_lgbm_regressor.ModelLGBMRegressor'''
        model_dir = os.path.join(os.getcwd(), 'model_test_123456789')
        remove_dir(model_dir)
    ...
    def test04_model_lgbm_regressor_reload_from_standalone(self):
        '''Test of the method {{package_name}}.models_training.regressors.models_sklearn.model_lgbm_regressor.ModelLGBMRegressor.reload_from_standalone'''
        ...
        new_model = ModelLGBMRegressor(model_dir=model_dir_2)
