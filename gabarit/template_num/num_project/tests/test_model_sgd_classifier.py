...
class ModelSGDClassifierTests(unittest.TestCase):
    ...
    def test01_model_sgd_classifier_init(self):
        '''Test of {{package_name}}.models_training.classifiers.models_sklearn.model_sgd_classifier.ModelSGDClassifier.__init__'''
    ...
    def test02_model_sgd_classifier_predict(self):
        '''Test of the method predict of {{package_name}}.models_training.classifiers.models_sklearn.model_sgd_classifier.ModelSGDClassifier'''
    ...
    def test03_model_sgd_classifier_predict_proba(self):
        '''Test of the method predict_proba of {{package_name}}.models_training.classifiers.models_sklearn.model_sgd_classifier.ModelSGDClassifier'''
    ...
    def test04_model_sgd_classifier_get_predict_position(self):
        '''Test of the method {{package_name}}.models_training.classifiers.models_sklearn.model_sgd_classifier.ModelSGDClassifier.get_predict_position'''
    ...
    def test05_model_sgd_classifier_save(self):
        '''Test of the method save of {{package_name}}.models_training.classifiers.models_sklearn.model_sgd_classifier.ModelSGDClassifier'''
    ...
    def test06_model_sgd_classifier_reload_from_standalone(self):
        '''Test of the method {{package_name}}.models_training.classifiers.models_sklearn.model_sgd_classifier.ModelSGDClassifier.reload_from_standalone'''
