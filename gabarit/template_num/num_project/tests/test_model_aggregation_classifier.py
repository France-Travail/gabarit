...
class ModelAggregationClassifierTests(unittest.TestCase):
    ...
    def test01_model_aggregation_classifier_init(self):
        ...
        # if the object list_model has other model than model calssifier (model_aggregation_classifier is only compatible with model classifier)
    ...
    def test05_model_aggregation_classifier_predict(self):
        ...
        model = ModelAggregationClassifier(model_dir=model_dir, list_models=list_models, aggregation_function='majority_vote')
        ...
        # All models have the same labels
        list_models = [list_model_mono[0], list_model_mono[1]]
        model = ModelAggregationClassifier(model_dir=model_dir, list_models=list_models, aggregation_function='proba_argmax')
        test_method(model, dic_mono['x_test'], target_predict=dic_mono['target_1'], target_probas_shape=dic_mono['target_probas_1_shape'])
        remove_dir(model_dir)
        ...
        # All models have the same labels
        list_models = [list_model_mono[0], list_model_mono[1]]
        model = ModelAggregationClassifier(model_dir=model_dir, list_models=list_models, using_proba=False, multi_label=False, aggregation_function=function_test)
        test_method(model, dic_mono['x_test'], target_predict=dic_mono['target_1'], target_probas_shape=dic_mono['target_probas_1_shape'])
        remove_dir(model_dir)
        ...
        list_models = [list_model_mono[0], list_model_mono[1]]
        model = ModelAggregationClassifier(model_dir=model_dir, list_models=list_models, aggregation_function='all_predictions')
        ...
        ##### All models have the same labels (mono_label)
        list_models = [list_model_mono[0], list_model_mono[1]]
        model = ModelAggregationClassifier(model_dir=model_dir, list_models=list_models, aggregation_function='vote_labels')
        test_method(model, dic_multi['x_test'], target_predict=dic_mono['target_multi_1'], target_probas_shape=dic_mono['target_probas_1_shape'])
        remove_dir(model_dir)
    ...
    def test07_model_aggregation_classifier_get_predictions(self):
        ...
        list_models = [gbt, sgd]
        model = ModelAggregationClassifier(model_dir=model_dir, list_models=list_models, using_proba=False, aggregation_function='all_predictions', multi_label=True)
    ...
    def test09_model_aggregation_classifier_predict_model_with_full_list_classes(self):
        ...
        # return_proba
        model = ModelAggregationClassifier(model_dir=model_dir, list_models=[gbt1, gbt2])
        ...
        # return_proba
        model = ModelAggregationClassifier(model_dir=model_dir, list_models=[gbt1, gbt2], multi_label=True, aggregation_function='all_predictions')
        gbt1_predict_full_classes = model._predict_model_with_full_list_classes(gbt1, x_test, return_proba=True)
        self.assertEqual(gbt1_predict_full_classes.shape, (len(x_test), cols_all))
