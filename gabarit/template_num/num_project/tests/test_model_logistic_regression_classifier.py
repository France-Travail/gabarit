...
from {{package_name}}.models_training.classifiers.model_logistic_regression_classifier import ModelLogisticRegressionClassifier
...
class ModelLogisticRegressionClassifierTests(unittest.TestCase):
    ...
    def test01_model_logistic_regression_classifier_init(self):
        '''Test of {{package_name}}.models_training.classifiers.model_logistic_regression_classifier.ModelLogisticRegressionClassifier.__init__'''
    ...
    def test02_model_logistic_regression_classifier_predict(self):
        '''Test of the method predict of {{package_name}}.models_training.classifiers.model_logistic_regression_classifier.ModelLogisticRegressionClassifier'''
    ...
    def test03_model_logistic_regression_classifier_predict_proba(self):
        '''Test of the method predict_proba of {{package_name}}.models_training.classifiers.model_logistic_regression_classifier.ModelLogisticRegressionClassifier'''
    ...
    def test04_model_logistic_regression_classifier_get_predict_position(self):
        '''Test of the method {{package_name}}.models_training.classifiers.model_logistic_regression_classifier.ModelLogisticRegressionClassifier.get_predict_position'''
    ...
    def test05_model_logistic_regression_classifier_save(self):
        '''Test of the method save of {{package_name}}.models_training.classifiers.model_logistic_regression_classifier.ModelLogisticRegressionClassifier'''
    ...
    def test06_model_logistic_regression_classifier_reload_from_standalone(self):
        '''Test of the method {{package_name}}.models_training.classifiers.model_logistic_regression_classifier.ModelLogisticRegressionClassifier.reload_from_standalone'''
