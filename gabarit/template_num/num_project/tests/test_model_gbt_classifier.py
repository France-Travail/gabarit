...
class ModelGBTClassifierTests(unittest.TestCase):
    ...
    def test01_model_gbt_classifier_init(self):
        '''Test of {{package_name}}.models_training.classifiers.models_sklearn.model_gbt_classifier.ModelGBTClassifier.__init__'''
        ...
        # Check GBT params depending on multi-labels & multi-classes strategy
    ...
    def test02_model_gbt_classifier_predict(self):
        '''Test of the method predict of {{package_name}}.models_training.classifiers.models_sklearn.model_gbt_classifier.ModelGBTClassifier'''
    ...
    def test03_model_gbt_classifier_predict_proba(self):
        '''Test of the method predict_proba of {{package_name}}.models_training.classifiers.models_sklearn.model_gbt_classifier.ModelGBTClassifier'''
    ...
    def test04_model_gbt_classifier_get_predict_position(self):
        '''Test of the method {{package_name}}.models_training.classifiers.models_sklearn.model_gbt_classifier.ModelGBTClassifier.get_predict_position'''
    ...
    def test05_model_gbt_classifier_save(self):
        '''Test of the method save of {{package_name}}.models_training.classifiers.models_sklearn.model_gbt_classifier.ModelGBTClassifier'''
    ...
    def test06_model_gbt_classifier_reload_from_standalone(self):
        '''Test of the method {{package_name}}.models_training.classifiers.models_sklearn.model_gbt_classifier.ModelGBTClassifier.reload_from_standalone'''
        ...
        new_model = ModelGBTClassifier(model_dir=model_dir_2)
