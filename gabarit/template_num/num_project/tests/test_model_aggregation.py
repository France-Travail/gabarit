...
class Modelaggregation(unittest.TestCase):
    ...
    def test03_model_aggregation_has_model_classifier(self):
        '''Test of {{package_name}}.models_training.model_aggregation.ModelAggregation._has_model_classifier'''
    ...
    def test04_model_aggregation_has_model_regressor(self):
        '''Test of {{package_name}}.models_training.model_aggregation.ModelAggregation._has_model_regressor'''
