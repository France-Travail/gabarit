...
def main(filename: str, split_type: str, perc_train: float, perc_valid: float, perc_test: float,
         y_col: Union[str, int, None] = None, overwrite_dataset: bool = False,
    ...
    # Get dataframe
    # We load everything as string & fillna (avoid some errors)
...
if __name__ == '__main__':
    ...
    main(filename=args.filename, split_type=args.split_type, perc_train=args.perc_train,
         ...
         overwrite_dataset=args.overwrite_dataset, seed=args.seed, sep=args.sep,
