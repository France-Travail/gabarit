...
def predict(content: pd.DataFrame, model, batch_size: int = 128, alternative_version: bool = False, **kwargs) -> list:
    ...
    # Get predictions
    predictions = model.predict(df_prep, batch_size=batch_size, alternative_version=alternative_version)
...
def predict_with_proba(content: pd.DataFrame, model, batch_size: int = 128, alternative_version: bool = False,
    ...
    # Get predictions
    predictions, probas = model.predict_with_proba(df_prep, batch_size=batch_size, alternative_version=alternative_version)
